...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? 'FAQ') ?> - PedeAI Suporte</title>
...
<body>
    <div class="container my-5">
        <header class="text-center mb-5">
            ...
            <p class="lead">Respostas rápidas sobre as funcionalidades principais do seu sistema PedeAI.</p>
        </header>
        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <div class="text-center mt-5">
                    <p>Não encontrou sua resposta? <a href="/suporte" class="btn btn-sm btn-link">Voltar à Central de Suporte</a></p>
                </div>
